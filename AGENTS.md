...
- Live Render replica is a **Private Service** (`http://fortel2-replica:10000`). Do not convert it to Web or apply `render.yaml` as a new Blueprint (empty 20 GB disk vs live 50 GB). No public replica URL (ForteL2 D-0031).
